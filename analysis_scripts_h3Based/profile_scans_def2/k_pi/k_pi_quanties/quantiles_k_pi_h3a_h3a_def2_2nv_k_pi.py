...
parser.add_argument('hist_in', help='The statistically fluct. datahisto to try the scan on')

args = parser.parse_args()
hist_use = int(args.hist_in)
print hist_use
...
data_histo_use = pickle.load(open('/home/trwood/oscfit_output/hist_list_500_h3a_h3a.pckl'))  #used hist_list script as base

#print data_histo_use[0]

#hist_use

data_histu = data_histo_use[hist_use]
...
oscFitResults_fixed =fitter(data_histograms=[data_histu],
...
pickle.dump(oscFitResults_fixed,open('/gs/project/ngw-282-ac/trwood/jasper_home/JP_fraction_original_jan26_test_lessbins/analysis_scripts_h3Based/profile_scans_def2/outfiles/k_pi/quantiles/'+str(hist_use) +'def2_2nv_profilescan'+ str(dfrac_use) +'h3a_h3a.pckl', 'w'))
