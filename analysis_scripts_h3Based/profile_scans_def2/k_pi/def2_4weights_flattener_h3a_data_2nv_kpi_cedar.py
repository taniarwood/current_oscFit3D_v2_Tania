...
sysfile_use = '/home/trwood/projects/def-dgrant/trwood/osc_analysis/oscFit_3D_v2.0_andris_daydreamVerson_for_makingSYSFILES/scripts/Andreis_daydream_for_Tests/DRAGON_detector_systematics_albrecht_DMP_h3a3.pckl'
...
loader_nobkrd_a = dataLoader.dataLoader(observables =
	 ...
	 np.array([-3, 2, np.inf])],	
      ...
      user = 'Cedar_Chi2msu_no_background_noData_baselineONLY_flat_uncontained_numu_def2',
...
loader_dict_nue['user'] = 'Cedar_Chi2msu_no_background_noData_baselineONLY_flat_uncontained_nue_def2'
...
loader_pureBkrd  = dataLoader.dataLoader(observables =
      ...
      [10**np.linspace(0.75,2.25,11),
         np.arccos(np.linspace(-1.,1.,9))[::-1],
         np.array([-3, 2, np.inf])],
      user = 'Cedar_Chi2msu_BKGRND_only_flat_uncontained',
...
#loader_dict_atmos['weight_keys'] = ['tweight_newflat_e', 'tweight_newflat_e', 'tweight_newflat_mu_k', 'tweight_newflat_mu_p']
#loader_dict_atmos['user'] = 'Cedar_Chi2msu_BKGRND_only_flat_uncontained'
...
loader = dataLoader.dataLoader(observables =
	 ...
	 np.arccos(np.linspace(-1.,1.,9))[::-1],
	 np.array([-3, 2, np.inf])],
   #   user = 'Cedar_Chi2msu_no_background_noData_baselineONLY_flat_uncontained_mus2', 
      user = 'Cedar_Chi2msu_no_background_noData_baselineONLY_flat_uncontained_mus_def2',
      LEaxis = [],
      detsys_nuspecs = {},
      detsys_muspecs = {},
...
split_data = []
loader_dict['user'] = 'Cedar_Chi2msu_no_background_noData_baselineONLY_flat_uncontained_numu_def2'
...
split_data_e = []
loader_dict_e['user'] = 'Cedar_Chi2msu_no_background_noData_baselineONLY_flat_uncontained_nue_def2'
...
pickle.dump(oscFitResults_fixed,open('/gs/project/ngw-282-ac/trwood/jasper_home/JP_fraction_original_jan26_test_lessbins/analysis_scripts_h3Based/profile_scans_def2/outfiles/k_pi/def2_2nv_profilescan_data'+ str(dfrac_use) +'.pckl', 'w'))
