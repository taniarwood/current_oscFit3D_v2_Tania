...
pickle.dump(oscFitResults_fixed,open('/gs/project/ngw-282-ac/trwood/jasper_home/JP_fraction_original_jan26_test_lessbins/analysis_scripts_h3Based/profile_scans_def2/outfiles/k_pi/def2_2nv_profilescan'+ str(dfrac_use) +'h3a_h3a_5years.pckl', 'w'))
