...
fit_settings_fix    = {
      ...
      'theta23':        [0.74, False],
      'theta13':        [0.155, True],
      'oscMode':        'Prob3',#'Prob3', #'TwoNeutrino', #'Vacuum',  # 'TwoNeutrino', # 'Vacuum',
...
pickle.dump(oscFitResults_fixed,open('/gs/project/ngw-282-ac/trwood/jasper_home/JP_fraction_original_jan26_test_lessbins/analysis_scripts_h3Based/profile_scans_def2/outfiles/classic/def2_prob3_data_profilescan.pckl', 'w'))
