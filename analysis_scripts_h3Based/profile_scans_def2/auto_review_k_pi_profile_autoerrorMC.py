...
for item in nu_pi_range:
    new_item = '%.1f'%item   
    if os.path.isfile('/gs/project/ngw-282-ac/trwood/jasper_home/JP_fraction_original_jan26_test_lessbins/analysis_scripts_h3Based/profile_scans_def2/outfiles/k_pi/def2_2nv_profilescan'+str(new_item)+ 'h3a_h3a.pckl'): #def2_2nv_profilescan4.2h3a_h3a.pckl  
	...
	#data = pckl.load(open('/gs/project/ngw-282-ac/trwood/post_berlin_output/post_berlin_profiles_lowchi_azimov/frac1/outfiles/Asimov_allIN_review_offical_' + str(new_item) + 'Jan5_7binsNumu_5BinsNue_oneLessbin_wBurnSample10Percent_2018_2_twoNeutrino_norm_false_frac8_burn.pckl'))
        data = pckl.load(open('/gs/project/ngw-282-ac/trwood/jasper_home/JP_fraction_original_jan26_test_lessbins/analysis_scripts_h3Based/profile_scans_def2/outfiles/k_pi/def2_2nv_profilescan'+str(new_item)+ 'h3a_h3a.pckl'))
...
plt.grid(True)
#plt.legend()
plots_dir  = '/gs/project/ngw-282-ac/trwood/jasper_home/JP_fraction_original_jan26_test_lessbins/analysis_scripts_h3Based/profile_scans_def2/outfiles/k_pi/'
#plt.plot(nu_pi_range[idx], f[idx], 'ro')
plt.savefig(plots_dir + 'profile_scan_nupiscale_MC_def2_h3a_h3a.png')
#plt.savefig('/gs/project/ngw-282-ac/trwood/post_berlin_output/post_berlin_profiles_lowchi_azimov/plots_v/frac' + str(frac_num) + '/FracAzimovLowChi2'+str(frac_num)+'_mark_BURN10_2Neutrino_shortr.png')
...
#plt.plot(nu_pi_range[idx], f[idx], 'ro')
plt.savefig(plots_dir + 'profile_scan_nupiscale_MC_def2_h3a_h3a_short.png')
...
plt.figure(figsize=(8., 5))
plt.scatter(profile_scan_value, chi_value, linewidth=4, color = 'black',label =r'$\pi$ / K')  #= 'frac ' + str(frac_num) )
#plt.title(r'Profile Scan, Segmented Unfolding EnergyBin ' +str(frac_num), fontsize = 20)
plt.title(r'$\pi$ /K profile scan', fontsize = 20)
...
plt.savefig(plots_dir + 'profile_scan_nupiscale_MC_def2_h3a_h3a_v.png')
plt.figure(figsize=(8., 5))
...
plt.savefig(plots_dir + 'profile_scan_nupiscale_MC_def2_h3a_h3a_short2.png')
