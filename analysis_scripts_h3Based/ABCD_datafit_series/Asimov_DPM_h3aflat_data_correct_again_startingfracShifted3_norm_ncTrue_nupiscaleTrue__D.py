...
loader_nobkrd_a = dataLoader.dataLoader(observables =
	 ...
	 np.array([-3, 2, np.inf])],	
      ...
      user = 'Chi2msu_no_background_noData_baselineONLY_flat_uncontained_numu2',
...
loader_dict_nue['user'] = 'Chi2msu_no_background_noData_baselineONLY_flat_uncontained_nue2'
...
loader_dict_atmos['weight_keys'] = ['tweight_newflat_e', 'tweight_newflat_mu_k', 'tweight_newflat_mu_p']
...
data_settings = {
      ...
      'norm_e':                   1.,
      'domeff':                   1.,
      'nu_pi_scale':              1.0,  # this multiplies by 'tweight_DMP_GH_mu_p_jaspert' in the code everywehre, so it will wipe the third weight out
      'hole_ice':                 0.02,
      'atmmu_template':           'data',
      'simulation':               'baseline',
      'oscTables':                False,
...
split_data = []
loader_dict['user'] = 'Chi2msu_no_background_noData_baselineONLY_flat_uncontained_numu2'
...
split_data_e = []
loader_dict_e['user'] = 'Chi2msu_no_background_noData_baselineONLY_flat_uncontained_nue2'
...
fit_settings_fix    = {
      ...
      'theta23':        [0.74, False],
      'theta13':        [0.155, True],
      'oscMode':        'Prob3', #'TwoNeutrino', #'Vacuum',  # 'TwoNeutrino', # 'Vacuum',
      ...
      'nu_frac1':       [start_fractions_numu[0]+0.05, False],
      #'nu_frac1':       [dfrac_use, True],
      'nu_frac2':       [start_fractions_numu[1]+0.05, False],
      'nu_frac3':       [start_fractions_numu[2]-0.05, False],
      'nu_frac4':       [start_fractions_numu[3]- 0.05, False],
      'nu_frac5':       [start_fractions_numu[4] + 0.02, False],
      'nu_frac6':       [start_fractions_numu[5] - 0.01, False],
      'nu_frac7':       [start_fractions_numu[6] -0.01, False],

      'nu_frac8':       [start_fractions_nue[0], False],
      ...
      'nu_frac9':	 [start_fractions_nue[1], False],  
      'nu_frac10':       [start_fractions_nue[2], False],
      'nu_frac11':       [start_fractions_nue[3], False],
...
#	 loader_nobkrd_h,
	 ...
	 loader_pureBkrd],
      ...
      tol 		 = 0.001,  # condition, edm < edm_max, where edm_max = 0.0001 * tol* UP  ( UP = 1.0 chi2, -.5 llh, defalut 1.0).
...
pickle.dump(oscFitResults_fixed,open('/gs/project/ngw-282-ac/trwood/post_berlin_output/post_berlin_profiles_lowchi_azimov/Asimov_allIN_RESULTS_DPMH3a_data_lowerTol_again_shiftStartpointFractions3.pckl', 'w'))
