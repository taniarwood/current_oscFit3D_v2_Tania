...
import oscfit_default_values_oneless_tom
reload(oscfit_default_values_oneless_tom)
...
class dataLoader(object):
    ...
    def __init__(self, 
        ...
        self.default_data_settings = oscfit_default_values_oneless_tom.default_data_settings
