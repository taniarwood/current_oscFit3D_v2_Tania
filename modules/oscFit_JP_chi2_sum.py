...
import dataLoader_sum, miscFunctions, oscfit_default_values
from likelihoods import likelihoods
reload(dataLoader_sum)
...
#	print '                                                   '
	...
	atmmu_norm_error_fixed - scaling factor.  For 'standard behavior' set to a negiative value and this parameter will 
        ...
        if len(data_loaders) == 0:
            print 'oscFit: At least one dataLoader_sum object has to be given as an argument'
            exit()
        ...
        # These parameters do not change after every step and are needed in dataLoader_sum
        ...
        if len(self.blind_keys)>0: 
            ...
            print "Setting dataLoader_sum.verbose=False"
