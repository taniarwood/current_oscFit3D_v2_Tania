...
# JP removed it - flattening the flux will take care of this automatically. No need for it.
	...
	#nue_numu_cc_flux *= np.sum(numu_numu_ccflux_init)/np.sum(nue_numu_ccflux)
	...
	self.NoP_flatflux_module  = NoP_flatflux_module
        if self.flatflux_module != None:
        ...
        if self.NoP_flatflux_module != None:
            print 'The no pions flatflux module has been passed successfully!', self.NoP_flatflux_module.correction_factor_jp(10.0, 1.4)
        else:
            print 'The no pions flatflux module has NOT been passed'
